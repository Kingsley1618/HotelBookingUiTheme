...
<div ref={refTwo} onClick={()=> activeHandler(2)}  className={`flex select-none snap-center gap-x-2 md:flex-none flex-1 md:justify-start justify-center items-center cursor-pointer md:text-left text-center  md:px-[50px] px-[10px] py-[10px] ${section.secondSection ? "border-b-[2px] border-b-blue-400" : ""}`}><IoAirplane />   <h1 className='font-semibold'>Flight</h1></div>
