...
<button type="button" className='bg-[rgb(135,206,235)] cursor-pointer font-medium rounded-lg py-3 px-3  flex justify-center mx-auto items-center md:gap-x-2 gap-x-1 md:w-[50%] w-[70%]'><HiPaperAirplane /> <h1>Search flights</h1></button>
</div>
</div>
</div>
